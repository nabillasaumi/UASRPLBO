...
<!-- Select2 -->
<script src="<?= base_url('assets/admin-lte') ?>/plugins/select2/js/select2.full.min.js"></script>
<!-- DataTables  & Plugins -->
...
<script src="<?= base_url('assets/admin-lte') ?>/plugins/inputmask/jquery.inputmask.min.js"></script>
...
<!-- Jquery mask -->
<!-- <script src="<?=base_url('assets/download')?>/jQuery-Mask-Plugin-master/dist/jquery.mask.min.js"></script> -->
<!-- AdminLTE App -->
