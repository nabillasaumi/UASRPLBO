<head>
	...
	<!-- Select2 -->
	<link rel="stylesheet" href="<?= base_url('assets/admin-lte') ?>/plugins/select2/css/select2.min.css">
	<link rel="stylesheet" href="<?= base_url('assets/admin-lte') ?>/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css">
	<!-- JQVMap -->
